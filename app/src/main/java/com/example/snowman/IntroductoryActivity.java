...
public class IntroductoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        splashImg.animate().translationY(-2500).setDuration(1200).setStartDelay(4000);
        ...
        lottieAnimationView.animate().translationY(1800).setDuration(1200).setStartDelay(4000);
    }
